...
def batch_move_files(source_path_list: list) -> None:
    """
    Move files from a list of source paths. In this use case, images under `tiles` folder from `download_file2`
...
def main():
    # Get all folders from download_file2 folder
    source_path = os.path.join(os.path.dirname(__file__),'../download_file2')
